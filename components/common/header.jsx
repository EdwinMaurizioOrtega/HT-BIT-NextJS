            ...
            <div className="header-top">
                <div className="container">
                    <div className="header-left">
                        <p className="welcome-msg ls-normal">HT BUSINESS INNOVATION & TECHNOLOGY LLC - Cashback: Te devolvemos tu DINERO!</p>
                    </div>
            ...
            <div className="header-middle sticky-header fix-top sticky-content">
                <div className="container">
                    <div className="header-left mr-4">
                        ...
                        <ALink href="/">
                            <img src='./images/home/logo.png' alt="logo" style={{height: '60px', padding: '10px'}} />
                        </ALink>
                        ...
                        <div className="icon-box icon-box-side">
                            ...
                            <div className="icon-box-content d-lg-show">
                                <h4 className="icon-box-title text-dark text-normal">
                                    <ALink target="_blank" href="https://web.whatsapp.com/send?phone=1786680-4855&text=Hola." className="text-primary d-inline-block">Ventas WhatsApp</ALink>:</h4>
                                <p><ALink href="tel:#">+1 (786) 689-4855</ALink></p>
                            </div>
                        </div>
