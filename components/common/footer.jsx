            ...
            <div className="container">
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-3">
                            ...
                            <h2 style={{color: "white"}}>
                                HT BUSINESS INNOVATION & TECHNOLOGY LLC
                            </h2>
                    ...
                    <div className="row">
                            ...
                            <div className="widget widget-info">
                                ...
                                <ul className="widget-body">
                                    <li>
                                        ...
                                        <ALink href="tel:+1 (786) 332-9503">+1 (786) 689-4855</ALink>
                                    </li>
                                    <li>
                                        <label>Correo: </label>
                                        <ALink href="mailto:ceos@ht-bit.com">ceo@ht-bit.com</ALink>
                                    </li>
                                    <li>
                                        <label>Dirección: </label>
                                        <ALink href="#">6020 NW 99 AVE, UNIT 211 , DORAL, FL 33178</ALink>
                                    </li>
                                    <li>
                        ...
                        <div className="col-lg-2 col-md-6">
                            <div className="widget">
                                <h4 className="widget-title">Nuestros Partners</h4>
                                <ul className="widget-body">
                                    <li>
                                        <ALink href="https://hipertronics.us/">Hipertronics</ALink>
                                    </li>
                                    <li>
                                        <ALink href="https://movilcelistic.com/">MovilCelistic</ALink>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="col-lg-2 col-md-6">
                            <div className="widget">
                                ...
                                <ul className="widget-body">
                                    <li>
                                        <ALink href="#">Seguimiento de mi pedido</ALink>
                                    </li>
                                    <li>
                        ...
                        <div className="col-lg-2 col-md-6">
                            <div className="widget">
                                ...
                                <ul className="widget-body">
                                    <li>
                                        <ALink href="#">Sobre nosotros</ALink>
                                    </li>
                                    <li>
                ...
                <div className="footer-bottom">
                    ...
                    <div className="footer-center">
                        <p className="copyright">&copy; 2022. Built with love by HT BUSINESS INNOVATION & TECHNOLOGY LLC</p>
                    </div>
